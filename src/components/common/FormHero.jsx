...
const FormHero = () => {
   return(
  <>
<div class="relative -top-22 overflow-hidden bg-neutral-900">
  <div class="max-w-5xl mx-auto px-4 xl:px-0 pt-24 lg:pt-32 pb-24">
    <h1 class="font-semibold text-white text-5xl md:text-6xl">
      <span class="text-[#ff0] ">Kamakhaya flicks:</span> Transforming art into reality
    </h1>
...
<div class="relative -top-22  overflow-hidden pt-4 bg-neutral-900">
